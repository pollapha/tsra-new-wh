...
$q1  = "SELECT 
        ...
        tcm.Customer_Code,
        tcm.Customer_Name,
        DATE_FORMAT(pickh.Confirm_Picking_DateTime, '%d/%m/%y %H:%i') AS Confirm_Picking_DateTime
    FROM
...
$q1  .= "SELECT 
    ...
    WHERE
    $str
    GROUP BY pickh.Serial_Number , pickp.Part_No
    ORDER BY pickh.TS_Number, pickh.Serial_Number, pickp.Picking_Pre_ID ASC;";
...
while ($i < $data) {
    ...
    if (($j % 6) == 3) {
        ...
        $pdf->Code128(133, 151, $detailData[$j]['Mat_SAP1'], 30, 6);
