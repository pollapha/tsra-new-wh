...
while ($i < $data) {
    ...
    if (($j % 6) == 4) {
        $pdf->Code128(38, 206.5, $detailData[$j]['Part_No'], 60, 7);
        $pdf->Code128(37.5, 238.5, $detailData[$j]['Mat_SAP1'], 30, 6);
        $pdf->Code128(37.5, 251, $detailData[$j]['Mat_SAP3'], 30, 6);
        $pdf->Code128(73, 263.5, $detailData[$j]['Serial_ID'], 30, 7);
        $countrow1 = 1;
    }
    if (($j % 6) == 5) {
        $pdf->Code128(134, 206.5, $detailData[$j]['Part_No'], 60, 7);
        $pdf->Code128(133, 238.5, $detailData[$j]['Mat_SAP1'], 30, 6);
        $pdf->Code128(133.5, 251, $detailData[$j]['Mat_SAP3'], 30, 6);
        $pdf->Code128(168.5, 263.5, $detailData[$j]['Serial_ID'], 30, 7);
        $countrow1 = 1;
    }
