var header_ViewPSWheelLip = function () {
    var menuName = "ViewPSWheelLip_", fd = "Shipping/" + menuName + "data.php";
    ...
    return {
        view: "scrollview",
        scroll: "native-y",
        id: "header_ViewPSWheelLip",
        body:
        {
            id: "ViewPSWheelLip_id",
            type: "clean",
            rows:
                [
                                ...
                                },
                                {
                                    ...
                                    onClick:
                                    {
                                        "mdi-file": function (e, t) {
                                            ...
                                            window.open("print/doc/ts.php?data=" + data, '_blank');
                                        },
